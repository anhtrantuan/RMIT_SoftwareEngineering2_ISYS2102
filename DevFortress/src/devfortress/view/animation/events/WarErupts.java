 ...
 * @author Sherlock
 */
public class WarErupts extends Game2D implements EventAnimationEngine{
    ...
    public WarErupts(Dimension dim) {
        super(dim);
    }
    ...
    public void initGame() {
        URL bgrURL = getClass().getResource("../../resources/imgWar.png");
        try {
    ...
    public String getInformation(){
        return "War Erupts!!! 2/3 employees have to leave the company to serve military"
                + ". The others are unhappy";
    }
}
