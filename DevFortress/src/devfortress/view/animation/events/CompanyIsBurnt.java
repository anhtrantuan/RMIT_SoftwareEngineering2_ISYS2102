 ...
 * @author Sherlock
 */
public class CompanyIsBurnt extends Game2D implements EventAnimationEngine{
    ...
    public CompanyIsBurnt(Dimension dim){
        super(dim);
    }
    ...
    public void initGame() {
        URL bgrURL = getClass().getResource("../../resources/imgBurning.png");
        try {
    ...
    public String getInformation() {
        return "Company is burnt down by anonymous hater, lost 2/3 total money,"
                + "only loyal employees stay";
    }
}
