 ...
 * @author Sherlock
 */
public class ZombieApocalypse extends Game2D implements EventAnimationEngine{
    ...
    public ZombieApocalypse(Dimension dim) {
        super(dim);
    }
    ...
    public void initGame() {
        URL bgrURL = getClass().getResource("../../resources/imgZombieApocalypse.png");
        try {
    ...
    public String getInformation(){
        return "ZOMBIE APOCALYPSE! Now business is nothing, try to be tasty instead!";
    }
}
