...
public class Constant {
    ...
    public static String AVAILABLE_EMPLOYEES = "Available Employees";
    ...
    public static String BUTTON_CONTRACT = "Contract New Project";
    public static String BUTTON_HIRE = "Hire New Employee";
